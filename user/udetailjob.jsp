...
<c:if test="${empty user }">
	...
	<div><a href="user/userlogin.jsp" class="btn btn-success width-12" style="color:#fff">登录</a></div>	
		...
		<div class="list-group">
			...
			<div class="list-group-item">
				<input type="button" value="申请报名" class="width-12 btn bg-main"
			 		onclick="location.href='/JoinServlet?jid=${job.jid}&bid=${job.businessid }&lastnum=${job.lastnum}&personnum=${job.personnum}';"/>
			</div>
			</div>
		</div>
	</div>
