...
<div class="container center-block"><!-- article -->
	...
	<c:if test="${not empty business }">
		<form:form action="BusinessAddJobBB" method="post"
			 onsubmit="return checkForm();">
			<div class="" style="width:100%;overflow:hidden;padding:20px;">
				<!-- article -->
				<table class="aj_info">
					<tr>
						<td class="width-2">兼职标题：</td>
						<td class="width-5"><input type="text" name="title" id="title" onblur="checktitle()" class="form-control" /><span
							style="display:inline-block;margin-left:10px;color:#ddd">比如：某某公司招聘发单员</span>
						</td>
						<td class="width-4"><span id="spantitle"></span></td>
					</tr>
					<tr>
						<td class="width-2">兼职分类：</td>
					...
					<tr>
						<td class="width-2">兼职地区：</td>
						<td><select name="area" id="area" onblur="checkarea()" class="jz_input">
					...
					<tr>
						<td class="width-2">兼职时薪：</td>
						<td><input type="text" name="salary" id="salary" onblur="checksalary()" class="jz_input"/>
						</td>
						<td><span id="spansalary"></span></td>
					</tr>
					<tr>
						<td class="width-2">招收总人数：</td>
						<td><input type="text" name="personnum" id="personnum" onblur="checkpersonnum()" class="jz_input"/><span
							style="display:inline-block;margin-left:10px;color:#ddd">/人(请填入数字)</span>
						</td>
						<td><span id="spanpersonnum"></span></td>
					</tr>
					<tr>
						<td class="width-2">兼职内容：</td>
						<td>
					...
					<tr>
						<td class="width-2">报名截止时间：</td>
						<td><input type="text" name="endtime" id="endtime" onblur="checkendtime()" class="jz_input" onclick="WdatePicker()"/> <span
							style="display:inline-block;margin-left:10px;color:#ddd">比如：2015年8月25日</span>
						</td>
						<td><span id="spanendtime"></span></td>
					</tr>
					<tr>
						<td class="width-2">面试时间：</td>
						<td><input type="text" name="interviewtime" id="interviewtime" onblur="checkinterviewtime()" class="jz_input" onclick="WdatePicker()" />
							<span style="display:inline-block;margin-left:10px;color:#ddd">比如：2015年8月25日</span>
						</td>
						<td><span id="spaninterviewtime"></span></td>
					</tr>
					<tr>
						<td class="width-2">培训时间：</td>
						<td><input type="text" name="traintime" id="traintime" onblur="checktraintime()" class="jz_input" onclick="WdatePicker()"/>
							<span style="display:inline-block;margin-left:10px;color:#ddd">比如：2015年8月25日
								&nbsp或者 &nbsp无</span></td>
								<td><span id="spantraintime"></span></td>
					</tr>
					<tr>
						<td class="width-2">工作时间：</td>
						<td><input type="text" name="worktime" id="worktime" onblur="checkworktime()" class="jz_input" onclick="WdatePicker()"/> <span
							style="display:inline-block;margin-left:10px;color:#ddd">比如：8:00~22:00</span>
						</td>
						<td><span id="spanworktime"></span></td>
					</tr>
					<tr>
						<td class="width-2">工作地点：</td>
						<td><input type="text" name="workplace" id="workplace" onblur="checkworkplace()" class="jz_input" />
							<span style="display:inline-block;margin-left:10px;color:#ddd">比如：万达广场</span>
						</td>
						<td><span id="spanworkplace"></span></td>
					</tr>
					<tr>
						<td class="width-2">性别需求：</td>
						<td><select name="gender" id="gender" onblur="checkgender()" class="jz_input" >
