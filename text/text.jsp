 ...
 <head>
  ...
  <body>
 	<div class="bg-main margin-bottom-lg"><!--header-->
		<div class="top"> 
			<a href="../index.jsp"><img src="../images/logo.png" alt="兼职么网"></img></a>				 				
...
<div class="bg-main text-white"><!--footer-->
	...
	<div class="bg-sub padding-top-sm padding-bottom-sm">
		<div style="height:20px;" class="width-9 center-block">
				<div class="pull=left" style="width:700px;display:inline-block;text-align:center;">版权所有 © <a href="http://www.vastsum.com"class="text-white">镇江巨和网络科技有限公司</a> All Rights Reserved，苏ICP备15014181号</div>
